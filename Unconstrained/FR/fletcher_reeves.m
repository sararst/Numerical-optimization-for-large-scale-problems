function[xk, fk, gradfk_norm, k, xseq, btseq, fseq, gfseq] = fletcher_reeves(x0, f, gradf, alpha0, kmax, tolgrad, c1, rho, btmax)
...
while k < kmax && gradfk_norm >= tolgrad
    ...
    if dot(pk,gradfk) > 0
        disp("!!! Warning: NOT A DESCENT DIRECTION !!!")
    end
...
%     gradfk_old = gradfk;
    ...
    beta = (gradfk_norm^2)/(gradfk_norm_old^2);
    pk = -gradfk + beta*pk;
